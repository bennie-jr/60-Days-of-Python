...
# The program tries to count and print out the number of periods
# in the "Trees are good. Grass is green." . However, running the
# main.py file returns an error. Please fix the error.
#
# main.py:
#
# import functions
