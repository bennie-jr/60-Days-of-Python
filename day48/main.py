...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create menu bar and add file, help and edit buttons 
        ...
        # Use the line below if only your about item does not show
    ...
    def load_data(self):
        # Refresh table always with database values
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was created to help anyone with student management.
        Feel free to modify to your preference and reuse the app.
        """ 
...
class DeleteDialog(QDialog):
    ...
    def delete_student_record(self):
        ...
        # Add message box to confirm deletion
