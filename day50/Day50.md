...
Today, I started working on a job application form web app using flask. I set up my environment and created the app structure, flask follows a specific file and folder structure. I wrote a simple flask app implementation for the backend which routes http requests to the frontend(index.html) file in the templates folder. I started building the frontend and wrote the html code for how I wanted the job application form to look like. When I was done with the html layout of the frontend, I proceeded to styling with boostrap. I used bootstrap for the css styling and I was able to finish the frontend. I will add more functionality to the backend tomorrow.

Day 50 was good, I am learning more and more each day. I will continue building app 14 tomorrow.
