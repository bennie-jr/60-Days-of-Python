...
# Alina has created a speed calculation function.She traveled a total of
# 200 miles today which took her two hours.She wants to use her function
...
#
# TypeError: speed() missing 1 required positional \
# argument: 'time'
#
